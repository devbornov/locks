...
#                     f"Please wait for the locksmith to accept your request.\n"
#                     f"You will be notified once it's accept or denied."
#                 )
...
#                     f"Thank you."
#                     f"Please accept or deny this booking."
#                 )
...
#             f"A refund will be processed, and you may choose another service provider.\n"
#             f"Thank you for using LockQuick."
#         )
#         send_sms(booking.customer_contact_number or customer.phone_number, customer_message)

#         # TODO: Implement refund logic with Stripe here
...
#         # Check booking status - must be Approved to complete
#         if booking.status != "Approved":
#             return Response({'error': 'Booking must be approved by the locksmith before completion.'}, status=400)
